...
def filter_chunks(input_path, output_path, subject_ids=None, item_ids=None):
...
def filter_big_file(input_path, subject_ids=None, item_ids=None):
    tmp_path = "tmp"
    ...
    filter_chunks(input_path, tmp_path, subject_ids, item_ids)
