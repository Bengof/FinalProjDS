...
def save_filtered_inputevents():
    ...
    input_events_subject_id_itemid = input_events_subject_id[
        input_events_subject_id["itemid"].isin(get_inputevents_itemids())]
...
def save_filtered_chartevents():
    filtered_chartevents = chunk_filtering.filter_big_file("../data/icu/chartevents.csv", get_sepsis_subject_ids(),
                                                           get_chartevents_itemids())
...
def save_filtered_labevents():
    filtered_labevents = chunk_filtering.filter_big_file("../data/hosp/labevents.csv", get_sepsis_subject_ids(),
                                                         get_labevents_itemids())
...
def save_filtered_patients():
    ...
    patients_subject_ids = DIAGNOSES_ICD[DIAGNOSES_ICD["icd_code"].isin(sepsis_codes)][
