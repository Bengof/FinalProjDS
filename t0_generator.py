...
def get_t0():
    ...
    df_inputs_changed = df_inputs[df_inputs["statusdescription"] == "ChangeDose/Rate"][["stay_id", "subject_id", "starttime"]].sort_values(by="starttime")
    df_inputs_paused = df_inputs[df_inputs["statusdescription"] == "Paused"][["stay_id", "subject_id", "starttime"]].sort_values(by="starttime")
    df_inputs_stopped = df_inputs[df_inputs["statusdescription"] == "Stopped"][["stay_id", "subject_id", "starttime"]].sort_values(by="starttime")
